...
%%
function F = fun_solveMar4T1(var,parameters)
...
temp321 = theta+(r+lambda)/q_theta;
temp322 = delta*sigma*(1-beta);
part32 = epsilon_u-c_p*(temp321)/(temp322);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
part41 = epsilon_c;

temp421 = (c_f-c_p)*(theta+(r+lambda)/q_theta);
temp422 = sigma*(1-phi)*(1-beta)*(1+theta*q_theta/(r+lambda)-delta/(1-phi));
part42 = epsilon_u-temp421/temp422;
