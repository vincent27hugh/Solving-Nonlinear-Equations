function Ftest = symbolic_Jun13T1_III(xA,xB1,xB2,xmu,xepsilonu,...
    xcf,xcp,xbeta,xphi,xdelta,xsigma,xlambda,xb,xr,xpstar,...
    xepsilond,xepsilonc,xtheta,xalpha)
%JACOBIAN_JUN13_III
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
path0 = pwd;
add_path=strcat(path0,'\Functions\Task_1_sym\');
addpath(add_path);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
A = sym('A');
B1= sym('B1');
...
Ftest=subs(Ftest,...
    [A,B1,B2],...
    [xA,xB1,xB2]);
Ftest=subs(Ftest,mu,xmu);
Ftest=subs(Ftest,epsilonu,xepsilonu);
Ftest=subs(Ftest,[cf,cp,beta,phi,delta,sigma,lambda,b,r,pstar],...
    [xcf,xcp,xbeta,xphi,xdelta,xsigma,xlambda,xb,xr,xpstar]);
% 10 parameters
Ftest=subs(Ftest,epsilond,xepsilond);
Ftest=subs(Ftest,epsilonc,xepsilonc);
Ftest=subs(Ftest,theta,xtheta);
Ftest=subs(Ftest,alpha,xalpha);
%vpa(Ftest,5)
%{
ans =
