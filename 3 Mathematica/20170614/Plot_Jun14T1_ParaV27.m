...
for tt = v_tt
    ...
    for c = v_cc
       ...
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        save(strcat(path_data,str_fig,'_',str_para,'_dFdvar.mat'),'dFdvar','-v7.3');
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %% Plot
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %
        s1=subplot(2,2,1);
        plot(valpha(flag),dFdvar(1,flag),'LineWidth',2);
        ...
        %
        s2=subplot(2,2,2);
        plot(valpha(flag),dFdvar(2,flag),'LineWidth',2);
        ylabel(strcat('$\frac{\partial F_2}{\partial{',str_var,'}}$'),...
            'interpreter','Latex','FontSize',18,'FontWeight','bold');
        xlabel('$\alpha$','interpreter','Latex','FontSize',18,'FontWeight','bold');
        if ~isempty(valpha(flag))
            xlim([min(valpha(flag)),max(valpha(flag))]);
        ...
        %
        s3=subplot(2,2,3);
        plot(valpha(flag),dFdvar(3,flag),'LineWidth',2);
        xlabel('$\alpha$','interpreter','Latex','FontSize',18,'FontWeight','bold');
        ylabel(strcat('$\frac{\partial F_3}{\partial {',str_var,'}}$'),...
            'interpreter','Latex','FontSize',18,'FontWeight','bold');
        if ~isempty(valpha(flag))
            xlim([min(valpha(flag)),max(valpha(flag))]);
        else
        ...
        %
        s4=subplot(2,2,4);
        plot(valpha(flag),dFdvar(4,flag),'LineWidth',2);
        xlabel('$\alpha$','interpreter','Latex','FontSize',18,'FontWeight','bold');
        ylabel(strcat('$\frac{\partial F_4}{\partial {',str_var,'}}$'),...
            'interpreter','Latex','FontSize',18,'FontWeight','bold');
        if ~isempty(valpha(flag))
            xlim([min(valpha(flag)),max(valpha(flag))]);
        else
        ...
        str_fig2 = strcat(path_fig,str_fig,'_',str_para,'_dFdvar_flag');
