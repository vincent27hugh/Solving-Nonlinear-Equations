...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function parameters=myParameter_Apr11T2(typen,epsilon_u)
...
Names={'A';'B';'r';'c_p';'beta';'phi';'delta';'sigma';'lambda';...
    'pstar';'b';'c_f';'mu';'B1';'B2';'epsilon_u'};
Values=[A;B;r;c_p;beta;phi;delta;sigma;lambda;pstar;b;c_f;mu;B1;B2;...
    epsilon_u];
