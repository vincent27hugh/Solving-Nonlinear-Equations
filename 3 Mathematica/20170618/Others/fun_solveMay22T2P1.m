...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DELTAP_ps_dpms...
= fun_DELTAP_ps(epsilond_pms,epsilond_pms,epsilond_ps,...
epsilond_pps,tau_pms,tau_ps,tau_pps,g_p,mu);
...
part32 = c_p/((1-beta)*q_theta_pps);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
DELTAP_pps_dps...
= fun_DELTAP_pps(epsilond_ps,epsilond_pms,epsilond_ps,...
epsilond_pps,tau_pms,tau_ps,tau_pps,g_p,mu);
